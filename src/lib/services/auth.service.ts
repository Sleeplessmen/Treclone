...
export class AuthService {
    ...
    async login(credentials: unknown) {
        try {
            ...
            if (error instanceof AppError) throw error
            throw new AppError('Login failed', 400, ErrorCode.INTERNAL_ERROR)
        }
    }
    ...
    generateTokens(userId: bigint) {
        try {
            ...
            throw new AppError('Token generation failed', 500, ErrorCode.INTERNAL_ERROR)
        }
    }
    ...
    async refreshAccessToken(refreshToken: string) {
        try {
            ...
            try {
                ...
                // Check error type and throw appropriate AppError
            ...
            throw new AppError('Token refresh failed', 401, ErrorCode.INTERNAL_ERROR)
        }
    }
    ...
    async logout(refreshToken: string) {
        try {
            ...
            throw new AppError('Logout failed', 500, ErrorCode.INTERNAL_ERROR)
        }
    }
    ...
    async getUser(userId: bigint) {
        try {
            ...
            if (error instanceof AppError) throw error
            throw new AppError('Failed to fetch user', 500, ErrorCode.INTERNAL_ERROR)
        }
    }
    ...
    async resetPassword(credentials: unknown) {
        try {
            ...
            if (error instanceof AppError) throw error
            throw new AppError('Password reset failed', 500, ErrorCode.INTERNAL_ERROR)
        }
    }
    ...
    async verifyEmail(credentials: unknown) {
        try {
            ...
            if (error instanceof AppError) throw error
            throw new AppError('Email verification failed', 500, ErrorCode.INTERNAL_ERROR)
        }
    }
